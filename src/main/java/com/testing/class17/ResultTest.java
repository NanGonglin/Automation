...
//        List<Map<String, String>> sumarry = re.Sumarry("Cases\\Result\\resultofInter-0331-123938.xlsx", time);
...
//        System.out.println(s);
        ...
        Report.sendreport("Cases\\Result\\resultofInter-0331-123938.xlsx",time);
