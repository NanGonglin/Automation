...
public class SendMail {
	...
	public String myEmailAccount = "1766342177@qq.com";
	public String myEmailPassword = "dxfnzroobgmvfagc";

	// 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般(只是一般, 绝非绝对)格式为: smtp.xxx.com
	// 网易163邮箱的 SMTP 服务器地址为: smtp.163.com QQ邮箱为smtp.qq.com 在各大邮箱的设置中能够找到。
	public String myEmailSMTPHost = "smtp.qq.com";
	// 收件人邮箱（替换为自己知道的有效邮箱）
	public String receiveMailAccount = "15829254932@163.com";
	// 昵称,尽量设定，避免被识别为垃圾邮件
	public String nickname="海棠依旧";
	// 抄送名单
	public String copyMailAccount = "1766342177@qq.com";
	// 标题
	public String title = "测试邮件-来自园自动化测试框架！";
	// 属性
